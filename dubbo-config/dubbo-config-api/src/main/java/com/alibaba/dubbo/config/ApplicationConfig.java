...
public class ApplicationConfig extends AbstractConfig {
    ...
    // application name
    /**
     * 当前应用名称，用于注册中心计算应用间依赖关系，注意：消费者和提供者应用名不要一样，此参数不是匹配条件，你当前项目
     * 叫什么名字就填什么，和提供者消费者角色无关，比如：kylin应用调用了morgan应用的服务，则kylin项目配成kylin，
    ...
    // Java compiler
    // Java字节码编译器，用于动态类的生成，可选：jdk或javassi
